...
final class RecipeInfoCell: UICollectionViewCell {
    ...
    private func configureLabels() {
        ...
        NSLayoutConstraint.activate([calorificalLabel.centerYAnchor.constraint(equalTo: centerYAnchor),
        ...
        NSLayoutConstraint.activate([timeForPreparingLabel.centerYAnchor.constraint(equalTo: centerYAnchor),
